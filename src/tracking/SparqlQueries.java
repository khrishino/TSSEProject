...
public class SparqlQueries {
	...
	public static ResultSetRewindable query1(VirtGraph graph, int trackingId){
		...
		String build = "PREFIX tracking:<http://mivia.unisa.it/videotracking/tracking.owl#>\n"
						...
						+ "FROM <"+GRAPH+">\n"
						/* WHERE indica il pattern da matchare puÃ² contenere + di 1 pattern
						* e saranno considerati come in AND tra loro, quindi se 1 non trova match,
						* il risultato complessibo sarÃ  un grafo vuoto! */
						+ "WHERE {\n"
	...
	/**
	 * Restituisce il tempo di permanenza di ogni persona nella scena, Ã¨ possibile
	...
	/**
	 * Calcola la velocitÃ  media in cui si muovono le persone nella scena
	 * @param base
	 * @param speedTreshold
	 * @return
	 */
	...
	/**
	 * Calcola la velocitÃ  massima in cui si muovono le persone nella scena, se supera
