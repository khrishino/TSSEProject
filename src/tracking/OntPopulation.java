...
public class OntPopulation {
	...
	public String createBlob(String individual_id, String[] temp2, String idFrame) {
		 ...
		 * exitArea1: sopra a sinistra indice 4 = exitArea2: un po' piï¿½ in basso a
				...
				if (individ1 != null && individ2 != null && !individ1.equals(individ2)) {
					...
					if (sameDirection && (Math.abs(x1 - x2) <= threshX) && (Math.abs(y1 - y2) <= threshY)) { // Da
						...
						while (groupIt.hasNext() && !existingGroup) {
							...
							// Controllo se il generico gruppo esistente contiene giï¿½ le due persone in
							// esame
							...
							// Se il gruppo non ï¿½ piï¿½ vecchio di un certo numero di frame
							...
							// Se le contiene allora aggiorno solo la proprietï¿½ "lastSeenAt"
