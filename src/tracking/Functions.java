...
public class Functions {
	...
	/* Per il calcolo della velocità è stato fatto questo ragionamento: 
	 * - siccome il FrameRate è di 7 Frame per secondo, vuol dire che tra un Frame e l'altro passa un tempo pari a circa 0,14 secondi; 
	 * - per la distanza invece, bisogna tener conto che essa deve essere espressa in metri, mentre tale distanza è ottenuta in pixel,
	 *   pertanto, sapendo che un Metro è uguale a circa 3779 pixels, posso calcolare la distanza in metri attraverso la formua inversa;
	 * Pertanto, dividendo la distanza rispetto al tempo, è possibile ottenere la velocità */
